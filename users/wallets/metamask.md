...
Connect your Metamask wallet with Qom. {synopsis}
...
::: tip
If you are planning on developing on Qom locally and you haven’t already set up your own local node, refer to [the quickstart tutorial](../../validators/quickstart/run_node.md), or follow the instructions in the [GitHub repository](https://github.com/Qom/Qom/).
:::
...
3. Click the `Connect Wallet` button under `Qom Testnet`
...
```bash
qomd keys unsafe-export-eth-key dev0
```
