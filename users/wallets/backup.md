...
qomd keys add dev0
{
  "name": "dev0",
  "type": "local",
  "address": "qom1n253dl2tgyhxjm592p580c38r4dn8023ctv28d",
...
```bash
$ qomd keys add dev0-restored --recover
...
```bash
qomd keys unsafe-export-eth-key dev0 > dev0.export
...
```bash
$ qomd keys import dev0-imported ./dev0.export
Enter passphrase to decrypt your key:
```
...
```
$ qomd keys unsafe-import-eth-key dev0-imported ./dev0.export
