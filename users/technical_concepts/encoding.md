...
Learn about the encoding formats used on Qom. {synopsis}
...
previous versions, specially for client encoding and signing with Ledger devices. Qom does not
...
allows for quick reconstruction of encoded data. Qom uses RLP to encode/decode Ethereum
