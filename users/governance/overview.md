...
Qom One has an on-chain governance mechanism for passing
...
Venues involve community members to different degrees and individuals often perform multiple roles in the Cosmos ecosystem (validators, users, developers and core-members of Qom One Team). Because technical direction setting and development is almost always happening in the open, involvement from members in the extended community occurs organically.

- **[Qom One Discord](https://discord.gg/evmos)**
...
- **[Commonwealth](https://commonwealth.im/evmos)**
    ...
    - Qom One [proposals](https://commonwealth.im/evmos/proposals) list
- **[Telegram (@EvmosOrg)](https://t.me/EvmosOrg)**
    - General Qom One Telegram group
- **[Twitter (@EvmosOrg)](https://twitter.com/EvmosOrg)**
    - Official Qom One Twitter
