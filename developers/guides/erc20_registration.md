...
Learn how to register interoperable ERC-20s through [Qom One Governance](../../users/governance/overview.md). {synopsis}
...
To [submit the proposal](../../users/governance/submitting.md) to testnet through the command line with [`qomd`](../../validators/quickstart/binary.md), use the following command with `register-erc20`:

```bash
qomd tx gov submit-legacy-proposal register-erc20 ERC20_ADDRESS...\
  --title=<title> \
...
```bash
qomd tx gov submit-legacy-proposal register-erc20 --proposal=<path/to/proposal.json>
```
